...
import top.lobot.web.global.SQLConf;
...
import top.lobot.base.enums.ESex;
    ...
    public void login(@PathVariable("source") String source, AuthCallback callback, HttpServletResponse httpServletResponse) throws IOException {
        ...
        if (data.get(SysConf.GENDER) != null && !exist) {
            ...
            if (SysConf.MALE.equals(gender)) {
                user.setGender(ESex.MALE);
            } else if (SysConf.FEMALE.equals(gender)) {
                user.setGender(ESex.FEMALE);
            } else {
                user.setGender(ESex.UNKNOWN);
            }
        }
    ...
    public String decryptData(@RequestBody Map<String, String> map) throws UnsupportedEncodingException {
        ...
        if (resultMap != null) {
            ...
            if (userInfoMap.get(SysConf.GENDER) != null) {
                ...
                if (ESex.MALE.equals(gender)) {
                    user.setGender(ESex.MALE);
                } else if (ESex.FEMALE.equals(gender)) {
                    user.setGender(ESex.FEMALE);
                } else {
                    user.setGender(ESex.UNKNOWN);
                }
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(lobotWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(lobotWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(lobotWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
